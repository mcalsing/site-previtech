      ...
      <div className="grid justify-items-end p-10 space-y-9">
        ...
        <div className="border-2 border-sky-700 w-full p-5 rounded-xl">
          ...
          <div className="flex flex-row-reverse space-x-6 space-x-reverse pr-7">
            ...
            <a href="//linkedin.com/in/guilhermeropke/"><Image src="/linkedin-branco.png" alt="dyogo" width={30} height={24}></Image></a>
          </div>
        </div>
        ...
        <div className="border-2 border-sky-700 w-full p-5 rounded-xl">
          ...
          <div className="flex justify-between p-5">
            <p className="word-break: break-all text-xl">aasdsdfsasdfasdfsdfdfdsafsdfasdfasdfasdfasdfasdfasdfasdfasdffsdfsdfsdfsdfsdfssdfsdfsdfsdfsdfsdfsdfsdfsdffsdfsdfdfsdffsfsdfsdfsdsfsdfsdflkdfjalkdjflk</p>
            <Image src="/marcelo2.jpeg" alt="marcelo" width={100} height={24} className="hover:animate-pulse"></Image>
          </div>
          <div className="flex flex-row-reverse space-x-6 space-x-reverse pr-7">
        ...
        <div className="border-2 border-sky-700 w-full p-5 rounded-xl">
          ...
          <div className="flex flex-row-reverse space-x-6 space-x-reverse pr-7">
            ...
            <a href="//linkedin.com/in/sirlonbrehm/"><Image src="/linkedin-branco.png" alt="dyogo" width={30} height={24}></Image></a>
          </div>
        </div>
        ...
        <div className="border-2 border-sky-700 w-full p-5 rounded-xl">
          ...
          <div className="flex flex-row-reverse space-x-6 space-x-reverse pr-7">
            ...
            <a href="//linkedin.com/in/yeanjychen/"><Image src="/linkedin-branco.png" alt="dyogo" width={30} height={24}></Image></a>
          </div>
        </div>
